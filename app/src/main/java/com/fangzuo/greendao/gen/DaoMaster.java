...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        AddrBeanDao.createTable(db, ifNotExists);
        BarCodeDao.createTable(db, ifNotExists);
        BibieDao.createTable(db, ifNotExists);
        BibieTableDao.createTable(db, ifNotExists);
        BuyAtBeanDao.createTable(db, ifNotExists);
        BuyBeanDao.createTable(db, ifNotExists);
        ...
        StuffBeanDao.createTable(db, ifNotExists);
        ...
        UnitBeanDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        AddrBeanDao.dropTable(db, ifExists);
        BarCodeDao.dropTable(db, ifExists);
        BibieDao.dropTable(db, ifExists);
        BibieTableDao.dropTable(db, ifExists);
        BuyAtBeanDao.dropTable(db, ifExists);
        BuyBeanDao.dropTable(db, ifExists);
        ...
        StuffBeanDao.dropTable(db, ifExists);
        ...
        UnitBeanDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(AddrBeanDao.class);
        registerDaoClass(BarCodeDao.class);
        registerDaoClass(BibieDao.class);
        registerDaoClass(BibieTableDao.class);
        registerDaoClass(BuyAtBeanDao.class);
        registerDaoClass(BuyBeanDao.class);
        ...
        registerDaoClass(StuffBeanDao.class);
