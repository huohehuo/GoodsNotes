...
/** 
 * DAO for table "STUFF_BEAN".
*/
public class StuffBeanDao extends AbstractDao<StuffBean, Long> {

    public static final String TABLENAME = "STUFF_BEAN";

    /**
     * Properties of entity StuffBean.<br/>
    ...
    public StuffBeanDao(DaoConfig config) {
        super(config);
    }
    
    public StuffBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"STUFF_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"STUFF_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, StuffBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, StuffBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public StuffBean readEntity(Cursor cursor, int offset) {
        StuffBean entity = new StuffBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, StuffBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(StuffBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(StuffBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(StuffBean entity) {
