         ...
         thread =new Thread(new Runnable(){
            ...
            public void run() {
                try {
                    ...
                    mqttClient = App.getMqttClient(MQTTService.this);
...
// last will message
                    ...
                    String message = "{\"terminal_uid\":\"" + App.MQTT_ClientId + "\"} 当前id非正常断开连接前的最后一条信息";
                    ...
                    if ((!message.equals(""))) {
                        ...
                        try {
                            ...
                            options.setWill(App.TOPIC, message.getBytes(), 2, retained.booleanValue());
                        } catch (Exception e) {
...
//                    mqttClient.connect(options);
                    mqttClient.connect(options, MQTTService.this, new IMqttActionListener() {
                        @Override
...
//                    Toast.makeText(getApplicationContext(), "Something went wrong!" + e.getMessage(), Toast.LENGTH_LONG).show();
    ...
    private void startSubscribe(){
        try {
            mqttClient.subscribe(App.TOPIC, 2);
        } catch (MqttException e) {
            e.printStackTrace();
