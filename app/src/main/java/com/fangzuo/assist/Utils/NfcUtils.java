...
public class NfcUtils {
    ...
    public static String readNFCFromTag(Intent intent) throws UnsupportedEncodingException {
        ...
        Lg.e("tag",tag);
        readTagUltralight(tag);
        Lg.e("rawArrsy",rawArray);
        if (rawArray != null) {
            NdefMessage mNdefMsg = (NdefMessage) rawArray[0];
            NdefRecord mNdefRecord = mNdefMsg.getRecords()[0];
            Lg.e("mNdefMsg",mNdefMsg);
            Lg.e("nde",mNdefRecord);
            if (mNdefRecord != null) {
    ...
    public static String readTagUltralight(Tag tag) {
        ...
        try {
            ...
            Lg.e("readTagUltralight", "IOException while writing MifareUltralight message..."+
                    e.getMessage());
            return "读取失败！";
        } catch (Exception ee) {
            Lg.e("readTagUltralight", "IOException while writing MifareUltralight message..."+ ee.getMessage());
            return "读取失败！";
        } finally {
            if (mifare != null) {
                try {
                    ...
                    Lg.e("readTagUltralight", "Error closing tag..."+e.getMessage());
                }
            }
        }
    }
