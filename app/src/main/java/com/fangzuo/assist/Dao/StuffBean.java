...
public class StuffBean {
    ...
    public StuffBean(String FName,  String FCreateData,String FID) {
        this.FID = FID;
        this.FName = FName;
        this.FCreateData = FCreateData;
    }

    @Generated(hash = 967293048)
    public StuffBean(Long id, String FID, String FName, String FCreateData) {
        this.id = id;
        this.FID = FID;
        this.FName = FName;
        this.FCreateData = FCreateData;
    }
    @Generated(hash = 1630464157)
    public StuffBean() {
    }
    public Long getId() {
        return this.id;
